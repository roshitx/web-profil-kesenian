...
$tari = query("SELECT * FROM tari WHERE id = $id")[0];
...
<body>
    ...
    ?>
    <div class="container">
        <h1>Ubah Data Tari</h1>


        <form action="" method="POST" enctype="multipart/form-data">

            <input type="hidden" name="id" value="<?= $tari["id"]; ?>">
            <input type="hidden" name="gambarLama" value="<?= $tari["foto_pembimbing"]; ?>">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <img src="upload/<?= $tari['foto_pembimbing']; ?>" width="100px">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNamaPembimbing" name="nama_pembimbing" value="<?= $tari["nama_pembimbing"] ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputJadwal" name="jadwal" value="<?= $tari["jadwal"] ?>">
                </div>
            </div>
