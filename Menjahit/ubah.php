...
$menjahit = query("SELECT * FROM menjahit WHERE id = $id")[0];
...
<head>
    ...
    <title>Ubah Data menjahit</title>
</head>
...
<body>
    ...
    ?>
    <div class="container">
        <h1>Ubah Data Menjahit</h1>


        <form action="" method="POST" enctype="multipart/form-data">

            <input type="hidden" name="id" value="<?= $menjahit["id"]; ?>">
            <input type="hidden" name="gambarLama" value="<?= $menjahit["foto_pembimbing"]; ?>">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <img src="upload/<?= $menjahit['foto_pembimbing']; ?>" width="100px">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNamaPembimbing" name="nama_pembimbing" value="<?= $menjahit["nama_pembimbing"] ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputJadwal" name="jadwal" value="<?= $menjahit["jadwal"] ?>">
                </div>
            </div>
