...
// query data drumband berdasarkan id

$drumband = query("SELECT * FROM drumband WHERE id = $id")[0];
...
<head>
    ...
    <title>Ubah Data Drumband</title>
</head>
...
<body>
    ...
    ?>
    <div class="container">
        <h1>Ubah Data Drumband</h1>


        <form action="" method="POST" enctype="multipart/form-data">

            <input type="hidden" name="id" value="<?= $drumband["id"]; ?>">
            <input type="hidden" name="gambarLama" value="<?= $drumband["foto_pembimbing"]; ?>">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <img src="upload/<?= $drumband['foto_pembimbing']; ?>" width="100px">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNamaPembimbing" name="nama_pembimbing" value="<?= $drumband["nama_pembimbing"] ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputJadwal" name="jadwal" value="<?= $drumband["jadwal"] ?>">
                </div>
            </div>
