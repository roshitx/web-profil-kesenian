...
if(isset($_SESSION['session_username'])){
    header("location:Administrator/prestasi.php");
    exit();
}
...
<div class="container my-4">    
    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
        <div class="panel panel-info" style="border-color:#013a63;" >
            <div class="panel-heading" style="background-color:#013a63;">
                <div class="panel-title" style="color:#fff; font-family:'Montserrat';">Login untuk masuk ke sistem</div>
            </div>      
