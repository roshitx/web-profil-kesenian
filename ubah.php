...
<body>
    ...
    <div class="container">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <input type="hidden" name="gambarLama" value="<?= $prestasi["gambar"]; ?>">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputJudul" name="judul" placeholder="Masukan judul..." required value="<?= $prestasi["judul"] ?>">
                </div>
            </div>

            <div class="mb-3 row">
                <label for="inputKeterangan" class="col-sm-2 col-form-label">
                    <p>Keterangan :</p>
                </label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputKeterangan" name="keterangan" placeholder="Masukan keterangan..." value="<?= $prestasi["keterangan"] ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <img src="upload/<?= $prestasi['gambar']; ?>" width="100px">
