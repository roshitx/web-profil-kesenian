...
$teater = query("SELECT * FROM teater WHERE id = $id")[0];
...
<body>
    ...
    ?>
    <div class="container">
        <h1>Ubah Data Teater</h1>


        <form action="" method="POST" enctype="multipart/form-data">

            <input type="hidden" name="id" value="<?= $teater["id"]; ?>">
            <input type="hidden" name="gambarLama" value="<?= $teater["foto_pembimbing"]; ?>">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <img src="upload/<?= $teater['foto_pembimbing']; ?>" width="100px">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNamaPembimbing" name="nama_pembimbing" value="<?= $teater["nama_pembimbing"] ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputJadwal" name="jadwal" value="<?= $teater["jadwal"] ?>">
                </div>
            </div>
